...
int stack_UT_RunTests()
{
	...
	if (testInfo_0 != 1) totalFailed++;

	int testInfo_1 = RunTest_1();
	if (testInfo_1 != 1) totalFailed++;

	int testInfo_2 = RunTest_2();
	if (testInfo_2 != 1) totalFailed++;

	int testInfo_3 = RunTest_3();
	if (testInfo_3 != 1) totalFailed++;

	int testInfo_4 = RunTest_4();
	if (testInfo_4 != 1) totalFailed++;

	int testInfo_5 = RunTest_5();
	if (testInfo_5 != 1) totalFailed++;

	int testInfo_6 = RunTest_6();
	if (testInfo_6 != 1) totalFailed++;

	int testInfo_7 = RunTest_7();
	if (testInfo_7 != 1) totalFailed++;

	int testInfo_8 = RunTest_8();
	if (testInfo_8 != 1) totalFailed++;

	int testInfo_9 = RunTest_9();
	if (testInfo_9 != 1) totalFailed++;

	int testInfo_10 = RunTest_10();
	if (testInfo_10 != 1) totalFailed++;
